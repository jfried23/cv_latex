...
\textbf{{ $\varheartsuit$} python:} scikit-learn, pandas, numpy, scipy, flask, matplotlib, cython  \textbf{database:} mysql, json, mongodb, hdf \textbf{matlab:} signal processing, optimization toolbox \textbf{web:} html, javascript, d3.js \textbf{general:} git, regex
...
\begin{itemize}
\item Accelerated numerical simulations $\sim$10x  by implementing memoization algorithms to recognize and pre-cash simulation invariant systems of nonhomogeneous differential equations.
\item Implemented L1-norm reconstruction algorithms that reduced MRI scan time requirements in half.      
\end{itemize}}
