...
\section{contact}
454 1\textsuperscript{st} Ave; Apt 2F
New York, NY 10016
~
\href{mailto:josh.nmr@gmail.com}{josh.nmr@gmail.com} \ding{41} 
+1 (213) 537 4331 \ding{37}
~
...
\textbf{{ $\varheartsuit$} python:} scikit-learn, pandas, numpy, scipy, flask, matplotlib, cython  \textbf{database:} mysql, json, mongodb, hdf \textbf{c++:} boost,  \textbf{web:} html, javascript, d3 \textbf{general:} git, regex
%----------------------------------------------------------------------------------------
%	EDUCATION SECTION
%----------------------------------------------------------------------------------------
...
{\emph{Dynamics in DNA damage detection and repair} \\ This thesis explored the idea that money has been the cause of untold anguish and suffering in the world. I found that it has, in fact, not.}
